defmodule VeritiWeb.Router do
  use VeritiWeb, :router

  import VeritiWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {VeritiWeb.Layouts, :root}
  ...
  # scope "/api", VeritiWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:veriti, :dev_routes) do
  ...
  scope "/", VeritiWeb do
    ...
    live_session :current_user,
      on_mount: [{VeritiWeb.UserAuth, :mount_current_scope}] do
